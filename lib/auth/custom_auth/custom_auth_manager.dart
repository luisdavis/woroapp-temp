...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    woroAuthUserSubject.add(
      WoroAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<WoroAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  WoroAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = WoroAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    woroAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
